...
sculptprint.export_standard_view(r'\\Client\C$\Users\amarellapudi6\OneDrive - Georgia Institute of Technology\CASS\Solidworks-DFM-PlugIn\SculptPrint\Screenshots\View_SP.png', r'bottom')
