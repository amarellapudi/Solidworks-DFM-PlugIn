...
sculptprint.start()
sculptprint.new()
sculptprint.import_part(r'\\Client\C$\Users\amarellapudi6\OneDrive - Georgia Institute of Technology\CASS\Solidworks-DFM-PlugIn\SculptPrint\Parts\test.STL')
...
sculptprint.save_as(r'\\Client\C$\Users\amarellapudi6\OneDrive - Georgia Institute of Technology\CASS\Solidworks-DFM-PlugIn\SculptPrint\Imported_Fixtured_NoCutDefined_VolumeCreated.scpr')
