...
{
    public partial class MessageBox_Tolerance : Form
    {
        public MessageBox_Tolerance(string message, string title)
        {
            InitializeComponent();
        ...
        {
            MessageBox_Tolerance messageBox = new MessageBox_Tolerance(message, title);
